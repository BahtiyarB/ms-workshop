...
[![▶ Start the workshop](https://img.shields.io/badge/%E2%96%B6_Start_the_workshop-Step_01-2ea44f?style=for-the-badge)](https://github.com/BahtiyarB/ms-workshop/actions/workflows/start-workshop.yml)
...
<sub>Made a mistake? Use the [Reset workshop](https://github.com/BahtiyarB/ms-workshop/actions/workflows/reset-workshop.yml) workflow, or run `python .workshop/scripts/advance_step.py --reset --auto-commit` locally.</sub>
